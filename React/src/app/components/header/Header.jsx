...
const Header = () => {
    ...
    return (
        <header className="w-full bg-blue-600 py-4 px-6 flex justify-between items-center relative">
            <Link className="text-white text-2xl font-bold" href="/pages/home" >Gerenciador de Eventos</Link>
